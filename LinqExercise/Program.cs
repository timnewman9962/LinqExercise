...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var item in numbers.Where(x => x > 6))
            {
                Console.WriteLine(item);
            }
            Console.WriteLine("--------------------");
            ...
            foreach (var item in employees.Where(x => x.FirstName[0] == 'C' || x.FirstName[0] == 'S').OrderBy(x => x.FirstName))
            {
            ...
            foreach (var item in employees.Where(x => x.Age > 26).OrderBy(x => x.Age).ThenBy(x => x.FirstName) )
            {
            ...
            foreach (var item in employees.Where(x => x.YearsOfExperience <= 10 && x.Age > 35))
            {
            ...
            foreach (var item in employees.Append(new Employee("John", "Doe", 34, 1)))
            {
